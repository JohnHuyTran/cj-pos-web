...
export const featchTaxInvoicePrintHistoryAsync = createAsyncThunk('TaxInvoicePrintHistory', async (billNo: string) => {
  try {
...
const taxInvoicePrintHistorySlice = createSlice({
  ...
  extraReducers: (builer) => {
    builer.addCase(featchTaxInvoicePrintHistoryAsync.pending, () => {
      ...
      builer.addCase(featchTaxInvoicePrintHistoryAsync.fulfilled, (state, action: PayloadAction<any>) => {
