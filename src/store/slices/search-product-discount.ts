...
export const searchProductDiscount = createAsyncThunk('searchProductDiscount', async () => {
  try {
...
const searchProductDiscountSlice = createSlice({
  ...
  extraReducers: (builer) => {
    builer.addCase(searchProductDiscount.pending, () => {
      ...
      builer.addCase(searchProductDiscount.fulfilled, (state, action: PayloadAction<any>) => {
