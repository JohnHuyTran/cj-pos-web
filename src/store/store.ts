...
import stockAdjustBarcodeCalculateSlice  from './slices/stock-adjust-barcode-calculate-slice';
...
const store = configureStore({
  reducer: {
    ...
    stockAdjustBarcodeCalculateSlice: stockAdjustBarcodeCalculateSlice,
